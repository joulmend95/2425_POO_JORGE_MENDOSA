class Moto:
    ...
    def __str__(self):
        ...
        return f"Moto: {self.marca} {self.modelo}, Color: {self.color}, Velocidad: {self.velocidad} km/h"


# Ejemplo de creación y uso de un objeto Carro
mi_moto = Moto('rojo', 'Bajaj', 'Pulsar')

# Llamada al método __str__
print(mi_moto)  # Esto llamará automáticamente al método __str__ y mostrará la información del carro